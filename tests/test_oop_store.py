...
def test_smartphone_creation():
    smartphone = Smartphone(
        "Смартфон", "Описание", 50000, 10, 90, "Модель X", 128, "Чёрный"
    )
...
def test_lawn_grass_creation():
    lawn_grass = LawnGrass(
        "Газонная трава", "Описание", 2000, 5, "Россия", 10, "Зелёный"
    )
...
def test_add_products_different_types():
    smartphone_1 = Smartphone(
        "Смартфон1", "Описание", 50000, 10, 90, "Модель1", 128, "Чёрный"
    )
    smartphone_2 = Smartphone(
        "Смартфон2", "Описание", 60000, 5, 95, "Модель2", 128, "Белый"
    )
    lawn_grass = LawnGrass(
        "Трава газонная", "Описание", 3000, 20, "Россия", 10, "Зелёный"
    )
